...
def dgeco(A, N):
    ...
    .. note:: 1) array A is modified in place.
              ...
              :param float RCOND: an estimate of the reciprocal condition of A.
                        ...
                        the exact singularity is detected or the estimate
                        underflows.
    ...
    """
    # Some intermediate variables or original returning variables are never used outside, e.g.
    # YNORM, ANORM, RCOND and Z
    ...
    # Currently still keep it as a placeholder in case of any special debugging need in the future.
    _, IPVT = dgefa(A, N)
    ...
    # In the following code, L,U stands for the lower- and upper-triangular decomposition of A;
    ...
    Z *= S
    YNORM = S * YNORM
    # The following has to be commented otherwise 'tox -e flake8' shows error for unused 'RCOND'
    # if ANORM != 0.0:
    #     RCOND = YNORM / ANORM
    # else:
    #     RCOND = 0.0

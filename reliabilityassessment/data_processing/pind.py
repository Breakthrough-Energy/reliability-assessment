...
def pind(inputB_dict):
    ...
    :param dict inputB_dict: resulted dictionary from 'readInputB' function

    :param np.array ID:
        ID(I,K),K=0 to 2 : UNIT NUMBER, PLANT NUMBER, AREA OF LOCATION
                K=3 STARTING WEEK OF FIRST PLANNED OUTGE
